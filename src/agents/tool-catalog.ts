...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "code_search",
    label: "code_search",
    description: "Search code patterns (ripgrep)",
    sectionId: "code",
    profiles: ["coding"],
  },
  {
  ...
  },
  {
    id: "code_context",
    label: "code_context",
    description: "Gather imports, refs, context",
    sectionId: "code",
    profiles: ["coding"],
  },
  {
    id: "code_run",
    label: "code_run",
    description: "Run build/test with error parsing",
    sectionId: "code",
    profiles: ["coding"],
  },
  {
    id: "code_read",
    label: "code_read",
    description: "Read code with line numbers",
    sectionId: "code",
    profiles: ["coding"],
  },
  {
